    ...
    <div className="admin-layout">
      ...
      <main className="admin-main">
        ...
        <footer className={`admin-footer${isDashboard ? ' dashboard-footer' : ''}`}>
          {isDashboard ? (
            <>
              <div><strong>MaternalCare</strong><span>Hỗ trợ chuyên nghiệp cho mẹ và bé,<br />dựa trên chuyên môn lâm sàng và sự tận tâm chăm sóc.</span></div>
              ...
              <div><span>© 2026 Dịch vụ Chuyên nghiệp<br />MaternalCare. Bảo lưu mọi quyền.</span></div>
            </>
          ) : (
            <>
              <div><strong>MomMate</strong><span>© 2026 MaternalCare Professional Services.</span></div>
